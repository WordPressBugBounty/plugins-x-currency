...
namespace XCurrency\WpMVC\Container;

\defined('ABSPATH') || exit;
use ReflectionClass;
use ReflectionNamedType;
use XCurrency\Psr\Container\ContainerInterface;
use XCurrency\WpMVC\Container\Exception\ContainerException;
use XCurrency\WpMVC\Container\Exception\NotFoundException;
/**
