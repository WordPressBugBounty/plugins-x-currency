 ...
 */
namespace XCurrency\Symfony\Contracts\Service\Test;

use XCurrency\PHPUnit\Framework\TestCase;
use XCurrency\Psr\Container\ContainerInterface;
use XCurrency\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTestCase extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\XCurrency\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\XCurrency\Psr\Container\ContainerExceptionInterface::class);
