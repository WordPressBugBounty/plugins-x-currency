 ...
 */
namespace XCurrency\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'XCurrency\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'XCurrency\\Mes\\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'XCurrency\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'XCurrency\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'XCurrency\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'XCurrency\\Mon\\1'],
        // Default rule
        ['/s$/i', ''],
    ];
